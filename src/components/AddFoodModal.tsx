...
export default function AddFoodModal({ isOpen, onClose, mealType }: AddFoodModalProps) {
  ...
  // Base Nutritional Info (Per 100g/ml)
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-[#09090b]">
          <form onSubmit={handleAddFood} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-neutral-400 uppercase tracking-wider block">1. What are you eating?</label>
              <input
                required
                type="text"
                value={foodName}
                ...
                className="w-full bg-neutral-900 border-none focus:ring-1 focus:ring-emerald-500 text-sm rounded-xl p-3.5 text-neutral-200 focus:outline-none font-semibold transition-all"
              />
            </div>
            ...
            <div className="bg-[#121214] p-4 rounded-2xl border border-neutral-900 space-y-4">
              <div className="flex items-start gap-2">
                ...
                <label className="text-xs font-bold text-neutral-300 uppercase tracking-wider block">
                  2. Base Nutritional Info <span className="text-neutral-500">(Per 100g / 100ml)</span>
                </label>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="w-full bg-neutral-950 border-none focus:ring-1 focus:ring-emerald-500 text-sm rounded-xl p-3 text-neutral-200 focus:outline-none font-mono"
                  />
                </div>
                <div className="space-y-1.5">
            ...
            {/* 3. Quantity Consumed */}
            <div className="space-y-2">
              <label className="text-xs font-bold text-neutral-400 uppercase tracking-wider block">3. Quantity Consumed</label>
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="e.g. 250"
                  className="flex-1 bg-neutral-900 border-none focus:ring-1 focus:ring-emerald-500 text-sm rounded-xl p-3.5 text-neutral-200 focus:outline-none font-mono transition-all"
                />
                <select
                  value={unit}
                  onChange={(e) => setUnit(e.target.value as any)}
                  className="w-24 bg-neutral-900 border-none focus:ring-1 focus:ring-emerald-500 text-sm font-bold text-emerald-400 rounded-xl p-3 focus:outline-none cursor-pointer"
                >
